...
var CommentBox = React.createClass({displayName: "CommentBox",
        getInitialState: function() {
            return {commentData: [ {author: "Pete Hunt1", text: "This is one comment"},
                {author: "Jordan Walke", text: "This is *another* comment"}]};
        },
        render: function() {
            return (
                ...
                React.createElement(CommentList, {data: this.state.commentData}), 
...
var DynamicCommentList = React.createClass({displayName: "DynamicCommentList",
        ...
        render:function(){
            var commentNodes = this.props.dataAsync.map(function (comment) {
                return(
                    React.createElement(DynamicComment, {author: comment.author, text: comment.text}
