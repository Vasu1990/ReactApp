...
var CommentForm = React.createClass({displayName: "CommentForm",
    ...
    handleSubmit: function (e) {
        ...
        //calling event handler to mutate state in parent component since we cannot set state in child component
...
React.render(
React.createElement(DynamicCommentBox, {url: "data.json", pollInterval: 8000}),
...
var routes = (
    React.createElement(Route, {handler: DynamicCommentBox}, 
        React.createElement(Route, {path: "dynamic", handler: DynamicCommentList}), 
