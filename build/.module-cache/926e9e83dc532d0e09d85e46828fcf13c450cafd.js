        ...
        render: function() {
            return (
                React.createElement("div", {className: "commentBox"}, 
                         React.createElement("h1", null, "Hello, world! I am a ommentBox."), 
...
render: function() {
    ...
    React.createElement(DynamicCommentList, {dataAync: this.state.data1}), 
...
var DynamicCommentList = React.createClass({displayName: "DynamicCommentList",
        ...
        render:function(){
            var commentNodes = this.props.dataAync.map(function (comment) {
                return(
